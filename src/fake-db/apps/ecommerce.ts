  ...
  products: [
    {
      ...
      StoreName: 'Rich tomato-based curry with soft paneer cubes.'
    },
    {
      id: 2,
      ...
      StoreName: 'Spinach and cottage cheese curry.'
    },
    {
      id: 3,
      ...
      StoreName: 'Spicy chickpeas served with fried bread.'
    },
    {
      id: 4,
      ...
      StoreName: 'Crispy rice crepe with spicy potato filling.'
    },
    {
      id: 5,
      ...
      StoreName: 'Stuffed flatbread with spiced mashed potatoes.'
    },
    {
      id: 6,
      ...
      StoreName: 'Kidney beans curry with rice.'
    },
    {
      id: 7,
      ...
      StoreName: 'Spicy mashed vegetables with buttered buns.'
    },
    {
      id: 8,
      productName: 'Dhokla',
      ...
      StoreName: 'Steamed savory gram flour cake.'
    },
    {
      id: 9,
      ...
      StoreName: 'Aromatic rice cooked with mixed vegetables.'
    },
    {
      id: 10,
      ...
      StoreName: 'Paneer cubes in spicy tomato gravy.'
    }
  ],
  reviews: [
    {
      ...
      companyName: 'Rich tomato-based curry with soft paneer cubes.',
      productImage: '/images/apps/ecommerce/product-1.png',
      reviewer: 'Anaya',
      email: 'anaya1@example.com',
      avatar: '/images/avatars/1.png',
      date: '03/15/2022',
      status: 'High',
      review: 5,
      head: 'Delicious and satisfying',
      para: 'This dish exceeded expectations. Authentic taste and great presentation.'
    },
    {
      id: 2,
      product: 'Palak Paneer',
      companyName: 'Spinach and cottage cheese curry.',
      ...
      status: 'Moderate',
      review: 4,
      head: 'Fresh and flavorful',
      para: 'Palak Paneer was tasty, creamy, and just the right amount of spice.'
    },
    {
      id: 3,
      product: 'Chole Bhature',
      companyName: 'Spicy chickpeas served with fried bread.',
      ...
      status: 'Low',
      review: 3,
      head: 'Filling and flavorful',
      para: 'Good taste overall. Slightly oily but still worth it.'
    },
    {
      id: 4,
      product: 'Masala Dosa',
      companyName: 'Crispy rice crepe with spicy potato filling.',
      productImage: '/images/apps/ecommerce/product-4.png',
      reviewer: 'Amit',
      email: 'amit4@example.com',
      avatar: '/images/avatars/4.png',
      date: '08/12/2020',
      status: 'High',
      review: 5,
      head: 'Authentic South Indian taste',
      para: 'Crispy and well-stuffed. Served hot and fresh.'
    },
    {
      id: 5,
      product: 'Aloo Paratha',
      companyName: 'Stuffed flatbread with spiced mashed potatoes.',
      productImage: '/images/apps/ecommerce/product-5.png',
      reviewer: 'Nisha',
      email: 'nisha5@example.com',
      avatar: '/images/avatars/5.png',
      date: '01/03/2021',
      status: 'Moderate',
      review: 4,
      head: 'Comfort food classic',
      para: 'Reminded me of home. Would definitely order again.'
    }
  ],
  referrals: [
    {
